...
static SyscapWithNum arraySyscap[] = {
    ...
    {"SystemCapability.distributedhardware.distributed_input", DISTRIBUTEDHARDWARE_DISTRIBUTED_INPUT},
    ...
    {"SystemCapability.Security.DlpPermissionService", SECURITY_DLP_PERMISSION_SERVICE},
